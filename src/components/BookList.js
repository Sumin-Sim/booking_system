...
export default function BookList(props) {
    ...
    function modalClose() {
        ...
        document.querySelector('div#deleteModal input').value = "";
    }
    ...
    return (
        <div id="deleteModal">
            <div className="deleteModal">
                ...
                <div>
                    <label htmlFor={"deletePw" + props.data.id}>예약을 취소하시려면 예약 시 입력하셨던 <b>본인확인용 암호</b>를 입력해주세요.</label>
                    <input type="password" id={"deletePw" + props.data.id} name="deletePw"
                ...
                <p onClick={() => props.modalClose()}><AiOutlineClose /></p>
            </div>
        </div>
    );
}